...
module.exports = grammar({
  ...
  rules: {
    ...
    text: _ => prec(-1, // precedence might not be needed here
      /[^\n]/,
    ),

    _text: _ => prec(-1, // precedence might not be needed here
      /[^\n]/,
    ),
    ...
    bold: $ => prec.left(1, seq(
      "'''",
      alias(repeat1($._node), $.content),
      choice("'''", "’’’")
    )),

    italic: $ => prec.left(2, seq(
      "''",
      alias(repeat1($._node), $.content),
      choice("''", "’’")
    )),
