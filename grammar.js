  ...
  rules: {
    ...
    template: ($) =>
      seq(
        ...
        optional(repeat(alias($._template_parameter, $.template_parameter))),
        "}}",
      ),
    ...
    _template_parameter: ($) =>
      seq(
        "|",
        optional(alias($._template_param_name, $.param_name)),
        optional(seq("=", alias($._template_param_value, $.param_value))),
      ),
